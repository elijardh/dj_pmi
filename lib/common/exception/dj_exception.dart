...
class DjException implements Exception {
  final String message;
  final String? prefix;
  final Map<String, String>? cause;
  final String? statucCode;
  ...
  DjException({this.message = '', this.prefix, this.cause, this.statucCode});

  factory DjException.fromResponse(Response response) {
  ...
  factory DjException.fromDioException(DioException? e) {
